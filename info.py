...
# Bot information
SESSION = environ.get('SESSION', 'ays007')
API_ID = int(environ.get('API_ID', '29800171'))
API_HASH = environ.get('API_HASH', '4424a4973dc3154546fb4ba501ef62ed')
BOT_TOKEN = environ.get('BOT_TOKEN', "7840879880:AAFRgigS807FAkGqBQ5uuhJCIPICR5Taht4")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1260715375').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002345554946'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002339167159').split()]  # For Multiple Id Use One Space Between Each.
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002221127924')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ayushsingh07d:ayush07d@ayush.itw0z.mongodb.net/?retryWrites=true&w=majority&appName=Ayush")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "ayushsingh07d")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'ayushsingh07d')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+wapLFDkqyTRmNjJl')
