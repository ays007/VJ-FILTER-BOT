...
7840879880:AAFRgigS807FAkGqBQ5uuhJCIPICR5Taht4")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', 'https://t.me/drago_movie)).split()]  # For Multiple Id Use One Space Between Each.
...
DATABASE_NAME = environ.get('DATABASE_NAME', "ayu007")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'drago')
...
REFERAL_PREMEIUM_TIME = environ.get('', '') # time in week, day, month.
...
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'tttruzz') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.


# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/tayuuur')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/drago_movie')
